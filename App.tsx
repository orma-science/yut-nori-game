...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    return (
      <div className={`flex h-[1080px] w-[1920px] text-[#f5f5f5] overflow-hidden transition-colors duration-700 relative ${gameState.screenShake ? 'shake' : ''} ${gameState.theme === 'cyber' ? 'bg-[#000510]' : 'bg-[#0c0c0c]'}`}>
